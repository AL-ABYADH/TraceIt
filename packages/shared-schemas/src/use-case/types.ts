 ...
 */
export type CreatePrimaryUseCaseDto = z.infer<typeof createPrimaryUseCaseSchema>;
export type ProjectIdDto = z.infer<typeof projectIdSchema>;
export type UpdatePrimaryUseCaseDto = z.infer<typeof updatePrimaryUseCaseSchema>;

/**
 * Secondary use case types
 */
export type CreateSecondaryUseCaseDto = z.infer<typeof createSecondaryUseCaseSchema>;
export type UpdateSecondaryUseCaseDto = z.infer<typeof updateSecondaryUseCaseSchema>;
