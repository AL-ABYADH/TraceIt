...
> {
  ...
  createOne: (data: CreateData, configuration?: CreateDataParamsI) => Promise<Properties>;
  createMany: (data: CreateData[], configuration?: CreateDataParamsI) => Promise<Properties[]>;
