...
//   const base = path.basename(controllerFilePath).replace(".controller.ts", "");
...
//         rawName = undefined;
//       }
//       const fallback = path.basename(controllerPath).replace(".controller.ts", "");
...
//           path.basename(controllerPath).replace(".controller.ts", "");
...
//       if (e.isFile() && e.name.endsWith(".openapi.ts")) has = true;
...
//         else if (e.isFile() && e.name.endsWith(".openapi.ts")) files.push(full);
//       }
//     }
//     gather(dir);
